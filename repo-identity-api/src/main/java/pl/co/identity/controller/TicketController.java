...
public class TicketController {
    ...
    public ApiResponse<TicketResponse> create(Authentication authentication,
        ...
        return ApiResponse.ok(ticketService.create(principal, request));
    }
    ...
    public ApiResponse<TicketPageResponse> list(Authentication authentication,
        ...
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.list(principal, filter));
    }
    ...
    public ApiResponse<TicketResponse> get(Authentication authentication,
        ...
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.get(principal, ticketId));
    }
    ...
    public ApiResponse<TicketResponse> cancel(Authentication authentication,
                                              @PathVariable String ticketId) {
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.cancel(principal, ticketId));
    }
    ...
    public ApiResponse<TicketResponse> updateStatus(Authentication authentication,
        ...
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.updateStatus(principal, ticketId, request));
    }
    ...
    public ApiResponse<TicketCommentResponse> addComment(Authentication authentication,
        ...
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.addComment(principal, ticketId, request));
    }
    ...
    public ApiResponse<java.util.List<TicketCommentResponse>> listComments(Authentication authentication,
                                                                           @PathVariable String ticketId) {
        AuthPrincipal principal = (AuthPrincipal) authentication.getPrincipal();
        return ApiResponse.ok(ticketService.listComments(principal, ticketId));
    }
}
