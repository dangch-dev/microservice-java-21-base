...
public class SecurityConfig {
    ...
    public BaseJwtFilter baseJwtFilter(RSAPublicKey jwtPublicKey) {
        return new BaseJwtFilter(jwtPublicKey,
                java.util.List.of(),                       // skip patterns
                java.util.List.of("/internal/notifications/**")); // optional auth paths
    }

    @Bean
    public EmailVerifiedFilter emailVerifiedFilter() {
        return new EmailVerifiedFilter(java.util.List.of("/internal/notifications/**"));
    }
