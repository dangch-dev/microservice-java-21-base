...
public enum ErrorCode {
    // Validation / Input
    E200("200", HttpStatus.BAD_REQUEST,"Input Parameter Error (generic)"), // Input Parameter Error (generic)
    ...
    E217("217", HttpStatus.BAD_REQUEST,"Invalid image width"), // Invalid image width
    E218("218", HttpStatus.BAD_REQUEST,"Invalid image height"), // Invalid image height
    E219("219", HttpStatus.BAD_REQUEST,"File count exceeded"), // File count exceeded
    E244("244", HttpStatus.BAD_REQUEST,"Invalid phone number"), // Invalid phone number
    ...
    E238("238", HttpStatus.UNAUTHORIZED,"Username does not exist"), // Username does not exist
    E239("239", HttpStatus.UNAUTHORIZED,"Password incorrect"), // Password incorrect
    E234("234", HttpStatus.UNAUTHORIZED,"Authentication expired"), // Authentication expired
    E241("241", HttpStatus.UNAUTHORIZED,"Token invalid"), // Token invalid
    E248("248", HttpStatus.UNAUTHORIZED,"Invalid refreshToken"), // Invalid refreshToken
    E602("602", HttpStatus.UNAUTHORIZED,"OTP authentication failed"), // OTP authentication failed
    E242("242", HttpStatus.FORBIDDEN,"OTP expired"),    // OTP expired
    ...
    E280("280", HttpStatus.INTERNAL_SERVER_ERROR,"Server error"), // Server error
    E281("281", HttpStatus.SERVICE_UNAVAILABLE,"External API error"), // External API error
    E305("305", HttpStatus.BAD_GATEWAY,"Internal API call error"), // Internal API call error
    E282("282", HttpStatus.SERVICE_UNAVAILABLE,"Failed sending SMS"), // Failed sending SMS
    E650("650", HttpStatus.TOO_MANY_REQUESTS,"Retry limit reached"), // Retry limit reached

    // Generic fallbacks
    INTERNAL_ERROR("INTERNAL_ERROR", HttpStatus.INTERNAL_SERVER_ERROR,"INTERNAL_ERROR"),
    BAD_REQUEST("BAD_REQUEST", HttpStatus.BAD_REQUEST,"BAD_REQUEST"),
    UNAUTHORIZED("UNAUTHORIZED", HttpStatus.UNAUTHORIZED,"UNAUTHORIZED"),
    FORBIDDEN("FORBIDDEN", HttpStatus.FORBIDDEN,"FORBIDDEN"),
    NOT_FOUND("NOT_FOUND", HttpStatus.NOT_FOUND,"NOT_FOUND"),
    METHOD_NOT_ALLOW("METHOD_NOT_ALLOWED", HttpStatus.METHOD_NOT_ALLOWED,"Method does not allow"),
